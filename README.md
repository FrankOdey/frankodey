...
I’ve engineered **ISO8583 processors**, **HSM encryption SDKs**, **POS/MPOS integrations**, and **DevOps automation** for fintechs and financial institutions — including implementations with **NIBSS, PTSPs, UPSL, OPAY, HabariPay, eTranzact, and SmartCash**.
...
### **1. 🔐 HSM Encryption SDK (Python)**

Custom SDK for working with **Thales HSM**, enabling:  
✔ ZPK encryption  
✔ Key translation  
✔ Secure key exchange flows  
✔ Integration for POS/terminal vendors
...
### **3. 🧪 Transaction Message Simulator (C# + NodeJS)**
...
✔ POS/MPOS integrations  
✔ ISO8583-based gateways  
✔ Secure fintech infrastructure  
✔ Cloud-native microservices

I’d love to connect.

📧 **Email:** frankodey2@gmail.com  
🔗 **LinkedIn:** [https://linkedin.com/in/frankodey](https://linkedin.com/in/frankodey)  
💻 **GitHub:** [https://github.com/FrankOdey](https://github.com/FrankOdey)
